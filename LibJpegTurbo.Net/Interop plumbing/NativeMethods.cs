namespace LibJpegTurbo.Net
{
    ...
    internal static class NativeMethods
    {
        ...
        /// if the image is unpadded, or <see cref="TurboJpegUtilities.Pad32" />(<paramref name="width" /> *
        ...
        /// decompressed image is unpadded, else <see cref="TurboJpegUtilities.Pad32" />(<c>scaledWidth</c> *
        ...
        /// (re)allocated by <see cref="compress" /> or <see cref="transform" /> or that were manually allocated using 
        /// <see cref="alloc" />.</para>
        /// </summary>
